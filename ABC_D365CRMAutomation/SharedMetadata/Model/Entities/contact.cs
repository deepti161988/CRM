...
namespace SharedMetadata
{
	...
	public partial class Contact : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<SharedMetadata.Account> account_primary_contact
		{
			get
			{
				return this.GetRelatedEntities<SharedMetadata.Account>("account_primary_contact", null);
			}
			set
			{
				this.SetRelatedEntities<SharedMetadata.Account>("account_primary_contact", null, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<SharedMetadata.Contact> Referencedcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntities<SharedMetadata.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.SetRelatedEntities<SharedMetadata.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<SharedMetadata.Contact> Referencedcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntities<SharedMetadata.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.SetRelatedEntities<SharedMetadata.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
			}
		}
		...
		public SharedMetadata.Account contact_customer_accounts
		{
			get
			{
				return this.GetRelatedEntity<SharedMetadata.Account>("contact_customer_accounts", null);
			}
			set
			{
				this.SetRelatedEntity<SharedMetadata.Account>("contact_customer_accounts", null, value);
			}
		}
		...
		public SharedMetadata.Contact Referencingcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntity<SharedMetadata.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.SetRelatedEntity<SharedMetadata.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
			}
		}
		...
		public SharedMetadata.Contact Referencingcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntity<SharedMetadata.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
		...
		public SharedMetadata.Account msa_contact_managingpartner
		{
			get
			{
				return this.GetRelatedEntity<SharedMetadata.Account>("msa_contact_managingpartner", null);
			}
			set
			{
				this.SetRelatedEntity<SharedMetadata.Account>("msa_contact_managingpartner", null, value);
			}
		}
	}
}
